...
packet_sizes = [8, 16, 32, 64, 128, 256, 512, 1024]
            ...
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
                ...
                with conn:
                    ...
                    while True:
                        ...
                        data = conn.recv(8 + packet_size)
                        if not data:
                            break
                        times_ms.append(float((time.time_ns()) - struct.unpack('q' + '%sc' % packet_size, data)[0])/1000000)
                        #conn.sendall(data)
                    print(times_ms)
                    ...
                    print(packet_size*8/(avg_rtt/1000), packet_size*8/(min_rtt/1000), packet_size*8/(max_rtt/1000))
